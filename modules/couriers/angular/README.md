...
```bash
ng build couriers --watch
```

## Code scaffolding

Run `ng generate component component-name --project couriers` to generate a new component in the library.
