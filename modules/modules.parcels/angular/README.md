...
```bash
ng build parcels --watch
```

## Code scaffolding

Run `ng generate component component-name --project parcels` to generate a new component in the library.
...
```bash
npm install @modules/parcels
```

2. Import the module in your application:
```typescript
import { ParcelsModule } from '@modules/parcels';
