...
public class ShippingMvpDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        ShippingMvpGlobalFeatureConfigurator.Configure();
        ShippingMvpModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<ShippingMvpDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<ShippingMvpResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/ShippingMvp");

            options.DefaultResourceType = typeof(ShippingMvpResource);
        ...
        {
            options.MapCodeNamespace("ShippingMvp", typeof(ShippingMvpResource));
        });
    }
}
