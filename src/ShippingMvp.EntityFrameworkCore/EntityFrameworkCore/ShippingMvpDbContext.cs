    ...
    IParcelsDbContext
{
    ...
    public ShippingMvpDbContext(DbContextOptions<ShippingMvpDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        {
            b.ToTable(ShippingMvpConsts.DbTablePrefix + "Books",
                ShippingMvpConsts.DbSchema);
        ...
        //{
        //    b.ToTable(ShippingMvpConsts.DbTablePrefix + "YourEntities", ShippingMvpConsts.DbSchema);
        //    b.ConfigureByConvention(); //auto configure for the base class props
        //    //...
        //});
    }
