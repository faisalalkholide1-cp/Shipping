...
public class ShippingMvpEntityFrameworkCoreModule : AbpModule
{
    ...
    {
        context.Services.AddAbpDbContext<ShippingMvpDbContext>(options =>
        {
        ...
        Configure<AbpDbContextOptions>(options =>
        {
             ...
             * See also ShippingMvpDbContextFactory for EF Core tooling. */
