...
{
    [DbContext(typeof(ShippingMvpDbContext))]
    [Migration("20260606202331_Added_ParcelStatusHistory")]
    partial class Added_ParcelStatusHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Couriers.Domain.CourierProfile", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ShippingManagement.Parcels.Parcel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ParcelsParcels", (string)null);
                });

            modelBuilder.Entity("ShippingManagement.Parcels.StatusHistory.ParcelStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ParcelsParcelStatusHistories", (string)null);
                });

            modelBuilder.Entity("ShippingMvp.Books.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ShippingManagement.Parcels.StatusHistory.ParcelStatusHistory", b =>
                {
                    b.HasOne("ShippingManagement.Parcels.Parcel", null)
